        ...
        <section className="sm:px-[40px] lg:px-[100px] xl:px-[278px]">
          ...
          <div className="grid xl:grid-cols-2 sm:gap-y-[20px] sm:pb-[20px] md:gap-y-[60px] md:pb-[60px] lg:gap-y-[100px] lg:pb-[100px]">
            <div className="flex sm:max-md:flex-col items-center gap-4">
              <img src="https://drive.developershideout.com:4431/hoda_img/PRESS/1.png" 
            ...
            <div className="flex sm:max-md:flex-col items-center gap-4">
              <img src="https://drive.developershideout.com:4431/hoda_img/PRESS/2.png" 
                   className="max-w-[230px]"
                   alt="Image 2" 
              />
            ...
            <div className="flex sm:max-md:flex-col items-center gap-4">
              <img src="https://drive.developershideout.com:4431/hoda_img/PRESS/3.png" 
                   className="max-w-[230px]"
                   alt="Image 3" 
              />
